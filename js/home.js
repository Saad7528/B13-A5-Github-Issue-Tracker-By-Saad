    ...
    dataArray.forEach( item => {
        ...
        <div id="card" class="card card-body border-t-4 border-[#00A96E] shadow-lg space-y-3 p-4">
                    ...
                    <img src="./assets/Open-Status.png" alt="">
                        ${item.priority == "low" ? `<h2 class="bg-[#EEEFF2] px-6 py-1.5 rounded-full text-[#9CA3AF] uppercase font-medium">${item.priority}</h2>
                        </div>` : `<h2 class="bg-[#FEECEC] px-6 py-1.5 rounded-full text-[#EF4444] uppercase font-medium">${item.priority}</h2>
                        </div>`}
                    ...
                    ${item.labels[0]}</p>
                        ...
                        ${item.labels[1] ? `<div class="bg-[#FFF8DB] py-1.5 rounded-full outline-[#fbe27f] outline-1 px-6">

                        <p id="ppp" class="uppercase flex justify-center items-center gap-2 text-[#D97706] font-medium text-[12px]">
